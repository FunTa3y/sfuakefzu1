...
async def bonk_handler(message: Message):
    """
    > !бонкнуть @vcirnik
    > Тимур Богданов бонькнул(а) Влада Сырника 🧹
    """
    ...
    await edit_msg(
        ...
        message,
        text=(
            f"{await interactive.get_my_name()} бонькнул(а) "
...
async def cactus_handler(message: Message):
    ...
    > Тимур Богданов бросил(а) кактус в Влада Сырника 🌵
    """
    ...
    await edit_msg(
        ...
        message,
        text=(
            f"{await interactive.get_my_name()} бросил(а) кактус в "
            f"{await interactive.get_target_name()} &#127797;"
        )
    )
